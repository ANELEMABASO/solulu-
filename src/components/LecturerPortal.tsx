          ...
          <aside className="w-72 lg:w-80 bg-white border-l border-gray-100 p-5 overflow-y-auto space-y-6 hidden xl:block shrink-0 shadow-2xs">
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-xs font-bold text-gray-800">January 2026</span>
                <button className="text-gray-400 hover:text-gray-700 p-1">
              ...
              <div className="grid grid-cols-7 text-center text-xs gap-y-1 font-medium text-gray-700">
                ...
                <span>11</span>
                <span>12</span>
                {/* Active Highlighted Day 13 matching UNISA portal red theme */}
                <span className="w-6 h-6 rounded-full bg-[#DC2626] text-white font-bold flex items-center justify-center mx-auto shadow-xs">
                  13
                </span>
                <span>14</span>
                <span>15</span>
              ...
              <div className="grid grid-cols-2 gap-2 mt-4">
                <div className="p-2.5 rounded-xl bg-amber-50/60 border border-amber-100 text-center">
                  ...
                  <p className="text-[9px] text-gray-500">10 AM·12PM</p>
                </div>
